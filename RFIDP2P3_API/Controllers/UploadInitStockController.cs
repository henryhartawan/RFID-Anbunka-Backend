...
namespace RFIDP2P3_API.Controllers
{
    ...
    [ApiController]
    public class UploadInitStockController : ControllerBase
    {
        private readonly string _configuration;
        private string? remarks = "";

        public UploadInitStockController(IConfiguration configuration)
        {
        ...
        public ActionResult<IEnumerable<Dictionary<string,object>>> INQ(UploadInitStock uis)
        {
			...
			using (SqlCommand cmd = new SqlCommand("sp_Inq_Upload_Init_Last_Stock", conn))
			{
            ...
            using (var stream = new MemoryStream())
            {
                ...
                using (var package = new ExcelPackage(stream))
                {
                    ...
                    else
                    {
                        ...
                        {
                            conn.Open();
                            SqlCommand cmd = new("exec sp_Upload_T_Init_Last_Stock @EntryUser", conn);
