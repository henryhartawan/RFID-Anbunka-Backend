...
namespace RFIDP2P3_API.Controllers
{
    ...
    public class CalculateController : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<Dictionary<string,object>>> INQ()
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("SELECT * FROM T_Status WHERE Calc_Groups NOT IN ('Calc Monthly', 'Reset Calc Monthly') ORDER BY Calc_Date DESC", conn);
        ...
        public ActionResult<IEnumerable<Calculate>> Reset(Calculate calc)
        {
            ...
            using (SqlConnection conn = new SqlConnection(_configuration))
            {
                ...
                SqlCommand cmd = new SqlCommand("sp_Calc_Reset", conn);
